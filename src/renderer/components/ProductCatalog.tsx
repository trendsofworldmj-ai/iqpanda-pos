...
const PRODUCTS = [
  { id: '1', name: 'Manzana', category: 'FRUTAS', price: 35, emoji: '🍎' },
  { id: '2', name: 'Plátano', category: 'FRUTAS', price: 18, emoji: '🍌' },
  { id: '3', name: 'Naranja', category: 'FRUTAS', price: 20, emoji: '🍊' },
  { id: '4', name: 'Papa', category: 'VERDURAS', price: 22, emoji: '🥔' },
  { id: '5', name: 'Cebolla', category: 'VERDURAS', price: 28, emoji: '🧅' },
  { id: '6', name: 'Tomate', category: 'VERDURAS', price: 30, emoji: '🍅' },
]
